import { DEFAULT_AMOUNT_OF_ITEMS, DEFAULT_AMOUNT_OF_ITEMS_WINNERS, INITIAL_NUMBER_PAGE, ROUTES } from "./const";
...
export function getPaginatedData(items: CarsType[] | WinnersType[], page?: number, amount?: number) {
    ...
    const safeAmount = amount || isGarage ? DEFAULT_AMOUNT_OF_ITEMS : DEFAULT_AMOUNT_OF_ITEMS_WINNERS;
