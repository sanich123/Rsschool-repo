...
function CreateGame(isStarting, cols, currentWidth) {
  ...
  if (fromLocalStorage) {
    ...
    minutes = mins;
    counter.textContent = count;
    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_1__.widthChanger)(nodes, currentWidth, columns);
...
const almostDesktop = '(min-width: 768px)';
