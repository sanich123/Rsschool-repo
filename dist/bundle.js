...
function createGamePage() {
  ...
  !question ? innerQuestionBird = filtredBirds[(0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_3__.getRandomNumber)(filtredBirds.length)] : innerQuestionBird = question;
  ...
  nextBtn.addEventListener("click", () => {
    ...
    localStorage.removeItem(_utils_const_js__WEBPACK_IMPORTED_MODULE_7__.LOCAL_STORAGE_KEYS.answers);
    createGamePage(nextCounter, _utils_mocks_js__WEBPACK_IMPORTED_MODULE_8__.BIRDS_DATA_RU, "", null, _utils_const_js__WEBPACK_IMPORTED_MODULE_7__.MAX_GAP_SCORE, innerTotalScore);
  });
}
...
function createStartPage() {
  ...
  window.history.pushState({
    urlPath: _utils_const_js__WEBPACK_IMPORTED_MODULE_6__.PATHS.main
  }, '', _utils_const_js__WEBPACK_IMPORTED_MODULE_6__.PATHS.main);
  gameBtn.addEventListener('click', () => {
...
/* harmony import */ var _utils_mocks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/mocks */ "./src/js/utils/mocks.js");
...
function getNavLinks() {
  let language = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _utils_const__WEBPACK_IMPORTED_MODULE_4__.LANGUAGES.ru;
  ...
  const isRu = language === _utils_const__WEBPACK_IMPORTED_MODULE_4__.LANGUAGES.ru;
  const mainPage = document.querySelector(`.nav-list__btn--${isRu ? _utils_const__WEBPACK_IMPORTED_MODULE_4__.NAV_LINKS_RU[0] : _utils_const__WEBPACK_IMPORTED_MODULE_4__.NAV_LINKS_US[0]}`);
  const gamePage = document.querySelector(`.nav-list__btn--${isRu ? _utils_const__WEBPACK_IMPORTED_MODULE_4__.NAV_LINKS_RU[1] : _utils_const__WEBPACK_IMPORTED_MODULE_4__.NAV_LINKS_US[1]}`);
  const gallery = document.querySelector(`.nav-list__btn--${isRu ? _utils_const__WEBPACK_IMPORTED_MODULE_4__.NAV_LINKS_RU[2] : _utils_const__WEBPACK_IMPORTED_MODULE_4__.NAV_LINKS_US[2]}`);
  const lang = document.querySelector('.nav-list__btn--svg');
  lang.addEventListener('click', () => {
    const location = window.location.href;
    if (lang.innerHTML.includes('rus')) {
      lang.innerHTML = _utils_const__WEBPACK_IMPORTED_MODULE_4__.US_FLAG;
    } else {
      lang.innerHTML = _utils_const__WEBPACK_IMPORTED_MODULE_4__.RUS_FLAG;
    }
    const language = lang.innerHTML.includes('rus') ? _utils_const__WEBPACK_IMPORTED_MODULE_4__.LANGUAGES.ru : _utils_const__WEBPACK_IMPORTED_MODULE_4__.LANGUAGES.us;
    localStorage.setItem(_utils_const__WEBPACK_IMPORTED_MODULE_4__.LOCAL_STORAGE_KEYS.language, language);
    if (location.includes(_utils_const__WEBPACK_IMPORTED_MODULE_4__.PATHS.main)) {
      (0,_create_start_page_create_start_page__WEBPACK_IMPORTED_MODULE_0__.createStartPage)(language);
    } else if (location.includes(_utils_const__WEBPACK_IMPORTED_MODULE_4__.PATHS.game)) {
      (0,_create_game_create_game__WEBPACK_IMPORTED_MODULE_1__.createGamePage)(innerCounter, _utils_mocks__WEBPACK_IMPORTED_MODULE_5__.BIRDS_DATA_RU, innerChecked, innerQuestionBird.name, innerScore, innerTotalScore);
    } else if (location.includes(_utils_const__WEBPACK_IMPORTED_MODULE_4__.PATHS.results)) {
      (0,_create_results_create_results__WEBPACK_IMPORTED_MODULE_2__.createResults)(innerTotalScore);
    } else if (location.includes(_utils_const__WEBPACK_IMPORTED_MODULE_4__.PATHS.gallery)) {
      (0,_create_gallery_create_gallery__WEBPACK_IMPORTED_MODULE_3__.createGalleryPage)(innerCounter);
    }
  });
  mainPage.addEventListener("click", () => {
    window.history.pushState({
      urlPath: _utils_const__WEBPACK_IMPORTED_MODULE_4__.PATHS.main
    }, '', _utils_const__WEBPACK_IMPORTED_MODULE_4__.PATHS.main);
    localStorage.removeItem(_utils_const__WEBPACK_IMPORTED_MODULE_4__.LOCAL_STORAGE_KEYS.answers);
    (0,_create_start_page_create_start_page__WEBPACK_IMPORTED_MODULE_0__.createStartPage)();
  });
  gamePage.addEventListener("click", () => {
    window.history.pushState({
      urlPath: _utils_const__WEBPACK_IMPORTED_MODULE_4__.PATHS.game
    }, '', _utils_const__WEBPACK_IMPORTED_MODULE_4__.PATHS.game);
    localStorage.removeItem(_utils_const__WEBPACK_IMPORTED_MODULE_4__.LOCAL_STORAGE_KEYS.answers);
    (0,_create_game_create_game__WEBPACK_IMPORTED_MODULE_1__.createGamePage)();
  });
  gallery.addEventListener('click', () => {
    window.history.pushState({
      urlPath: _utils_const__WEBPACK_IMPORTED_MODULE_4__.PATHS.gallery
    }, '', _utils_const__WEBPACK_IMPORTED_MODULE_4__.PATHS.gallery);
    localStorage.removeItem(_utils_const__WEBPACK_IMPORTED_MODULE_4__.LOCAL_STORAGE_KEYS.answers);
