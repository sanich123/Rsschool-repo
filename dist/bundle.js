...
function createGamePage() {
  ...
  let score = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 5;
  ...
  answersList.addEventListener("click", _ref2 => {
    ...
    if (!target.disabled) {
      if (innerScore > 0) {
        createGamePage(innerCounter, _utils_mocks_js__WEBPACK_IMPORTED_MODULE_0__.birdsData, target.value, innerQuestionBird, --innerScore, innerTotalScore);
      } else {
        createGamePage(innerCounter, _utils_mocks_js__WEBPACK_IMPORTED_MODULE_0__.birdsData, target.value, innerQuestionBird, innerScore, innerTotalScore);
      }
    }
...
"use strict";
module.exports = __webpack_require__.p + "img/logo-icon.svg";
